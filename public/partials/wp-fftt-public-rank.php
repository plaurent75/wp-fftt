...
<?php
	...
	?>
		<tr>
			<td><?php echo $r['equipe'] ?></td>
			<td><?php echo $r['joue'] ?></td>
			...
			<td class="<?php echo $this->wpfftt_css_prefix ?>text-center"><a href="<?php echo $this->get_results_match_link($poule['iddiv'],$id_poule) ?>">&#8693;</a></td>
			<td class="<?php echo $this->wpfftt_css_prefix ?>text-right"><small><em><a class="<?php echo $this->wpfftt_css_prefix ?>text-muted" href="<?php echo $this->get_club_link($r['numero']) ?>"><?php echo $this->get_club_name($r['numero']) ?></em></small></a></td>
		</tr>
		<?php
	}
	?>
